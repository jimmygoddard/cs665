...
public class Turbo implements Option {
  ...
  private final String name = "Turbo injection";
  private final String description = "Increases acceleration";
  ...
  public String toString() {
    return new StringJoiner(", ", Turbo.class.getSimpleName() + "[", "]")
        .add("name='" + name + "'")
