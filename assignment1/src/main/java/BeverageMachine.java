...
public class BeverageMachine {
    ...
    /**
     * Choose the category of beverage for the beverage machine to make.  Can currently
    ...
    /**
     * Choose the type of beverage.  For tea this can be black, green, or yellow.  For coffee, this can be americano
     * espresso or latte machiato.  If coffee is being brewed, this will also prompt the user to choose if they
     * would like to add milk or sugar and how much.
     */
