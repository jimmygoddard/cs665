...
set CLASSPATH=%APP_HOME%\lib\assignment1.jar;%APP_HOME%\lib\guava-20.0.jar

@rem Execute assignment1
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %ASSIGNMENT1_OPTS%  -classpath "%CLASSPATH%" App %CMD_LINE_ARGS%
